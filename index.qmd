...
motivate why science needs collaborative efforts/ to build on prior work.

- the 2D:4D (digit ratio) and cognitive reflection literature, where we ran many studies in the past years.
- Lessons learned This part helps me explain basic concepts in a research based, applied manner, rather than giving textbook definitions. (I like that!) (I presume intro to pre-registration, what it is, why the ability to understand prior research also relies on nitty gritty details)
-  Explain what is pre-registration, when to use it, how widespread.
...
- What does that mean in practice [slides](https://larsvilhuber.github.io/readme-presentation/)
